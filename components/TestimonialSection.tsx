...
const TESTIMONIALS: Testimonial[] = [
  {
    ...
    name: "Д. Даваа",
    role: "Сүмийн гишүүн",
    content: "Илчлэлт сүмд ирснээр миний амьдрал, гэр бүлийн харилцаа маань Бурханы ивээлээр бүрэн өөрчлөгдсөн. Эндээс би жинхэнэ амар амгаланг олсон.",
    gender: 'male'
  },
  {
    id: 2,
  ...
  },
  {
    ...
    name: "Г. Амар",
    role: "Шинэ итгэгч",
    content: "Библийн хичээлүүд маш ойлгомжтой, амьдралд ойр байдаг. Миний асуултуудад хариулж, итгэл найдварыг минь бадрааж өгсөн хамт олондоо баярлалаа.",
    gender: 'male'
  },
  {
    id: 4,
  ...
  },
  {
    id: 5,
    name: "С. Туяа",
    role: "Эцэг эхийн төлөөлөл",
    content: "Хүүхдийн үйлчлэл маш сайн. Хүүхдүүд маань сүмд ирэх маш дуртай болсон. Тэдний маань хүмүүжилд сайнаар нөлөөлж байгаад сүмдээ талархаж байна.",
    gender: 'female'
  }
];

...
const POSTS: BlogPost[] = [
  ...
  {
    id: '1',
    title: "2024 оны Залуучуудын Чуулга уулзалт амжилттай боллоо",
    excerpt: "Өнгөрсөн амралтын өдрүүдэд Илчлэлт сүмийн залуучууд байгалийн сайханд цуглаж, нөхөрлөл болон сүнслэг өсөлтөөр дүүрэн цагийг өнгөрүүллээ.",
  ...
  },
  {
    ...
    category: "Сургалт",
    image: "https://lh3.googleusercontent.com/d/1gYlQPTDDuE3qfUSQIL-9pxJvLJztzGpD"
  },
  {
    id: '3',
